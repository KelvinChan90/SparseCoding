...
numFeatures = 256;    % number of features to learn, 121
patchDim = 14;         % patch dimension, 8
...
lambda = 5e-5;  % L1-regularisation parameter (on features)(default:5e-5)
epsilon = 1e-5; % L1-regularisation epsilon |x| ~ sqrt(x^2 + epsilon)(default:1e-5)
gamma = 1e-2   % L2-regularisation parameter (on basis)(default:1e-2)
